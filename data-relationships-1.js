window.NMT_DATA.STRUCTURES = [
  ...
  {id:'first-rib',name:'First rib',type:'bone-region',region:'upper thorax',summary:'Upper rib attachment and passage region relevant to scalene mechanics and neurovascular structures crossing toward the upper limb.',sourceIds:['brachial_plexus_statpearls','scalene_statpearls']},
...
window.NMT_DATA.RELATIONSHIPS = [
  ...
  {from:'scalenes',to:'first-rib',kind:'attachment / movement relationship',why:'Anterior and middle scalenes attach to the first rib, linking cervical activity with upper-rib mechanics.',sourceIds:['scalene_statpearls']},
  {from:'scalenes',to:'sternocleidomastoid',kind:'functional-overlap',why:'Both can contribute to cervical motion and accessory respiratory strategies, so one should not be inferred from neck tightness alone.',sourceIds:['scalene_statpearls','scm_statpearls']},
  {from:'scalenes',to:'levator-scapulae',kind:'clinical-comparison',why:'Both participate in cervical side-bending patterns, but levator also directly links the cervical spine to the scapula.',sourceIds:['scalene_statpearls','levator_statpearls']},
